...
export class PermissoesService {
  ...
  async update(
    id: string,
    updateData: Partial<CreatePermissaoDto>,
  ): Promise<Permissao> {
  ...
  async seedDefaultPermissions(): Promise<void> {
    const defaultPermissions = [
      ...
      // Contabilidade
      {
        codigo: 'CONTABILIDADE_READ',
        nome: 'Visualizar Contabilidade',
        descricao: 'Visualizar dados de contabilidade',
        modulo: 'contabilidade',
      },
      {
        codigo: 'CONTABILIDADE_WRITE',
        nome: 'Editar Contabilidade',
        descricao: 'Criar e editar dados de contabilidade',
        modulo: 'contabilidade',
      },
      {
        codigo: 'CONTABILIDADE_DELETE',
        nome: 'Excluir Contabilidade',
        descricao: 'Excluir dados de contabilidade',
        modulo: 'contabilidade',
      },

      // Orçamento e Financeiro
      {
        codigo: 'ORCAMENTO_READ',
        nome: 'Visualizar Orçamento',
        descricao: 'Visualizar dados orçamentários',
        modulo: 'orcamento',
      },
      {
        codigo: 'ORCAMENTO_WRITE',
        nome: 'Editar Orçamento',
        descricao: 'Criar e editar dados orçamentários',
        modulo: 'orcamento',
      },
      {
        codigo: 'ORCAMENTO_DELETE',
        nome: 'Excluir Orçamento',
        descricao: 'Excluir dados orçamentários',
        modulo: 'orcamento',
      },

      // Patrimônio
      {
        codigo: 'PATRIMONIO_READ',
        nome: 'Visualizar Patrimônio',
        descricao: 'Visualizar dados patrimoniais',
        modulo: 'patrimonio',
      },
      {
        codigo: 'PATRIMONIO_WRITE',
        nome: 'Editar Patrimônio',
        descricao: 'Criar e editar dados patrimoniais',
        modulo: 'patrimonio',
      },
      {
        codigo: 'PATRIMONIO_DELETE',
        nome: 'Excluir Patrimônio',
        descricao: 'Excluir dados patrimoniais',
        modulo: 'patrimonio',
      },
