...
export class RemoverCamposEnderecoAlunos1756927700000 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE alunos ADD COLUMN IF NOT EXISTS endereco TEXT`);
    await queryRunner.query(`ALTER TABLE alunos ADD COLUMN IF NOT EXISTS cep VARCHAR(10)`);
    await queryRunner.query(`ALTER TABLE alunos ADD COLUMN IF NOT EXISTS estado VARCHAR(2)`);
    await queryRunner.query(`ALTER TABLE alunos ADD COLUMN IF NOT EXISTS cidade_nome VARCHAR(100)`);
